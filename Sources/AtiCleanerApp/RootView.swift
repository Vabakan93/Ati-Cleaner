...
enum AppSection: String, CaseIterable, Identifiable {
    case overview, junk, large, duplicates, trash, uninstaller, memory
    var id:String{rawValue}
    var title:String{switch self{case .overview:"Genel Bakış";case .junk:"Sistem Çöpü";case .large:"Büyük Dosyalar";case .duplicates:"Çift Dosyalar";case .trash:"Çöp Kutusu";case .uninstaller:"Uygulama Kaldırıcı";case .memory:"Bellek"}}
    var icon:String{switch self{case .overview:"gauge";case .junk:"paintbrush.fill";case .large:"doc.richtext";case .duplicates:"doc.on.doc";case .trash:"trash";case .uninstaller:"xmark.app";case .memory:"memorychip"}}
    var tint:Color{switch self{case .overview:Theme.accent;case .junk:Theme.junk;case .large:Theme.large;case .duplicates:Theme.duplicates;case .trash:Theme.trash;case .uninstaller:Theme.uninstall;case .memory:Theme.memory}}
}
...
struct RootView: View {
    ...
    var body: some View {
        HStack(spacing:0){
            ...
            Group{switch selection{case .overview:OverviewView();case .junk:JunkView();case .large:LargeFilesView();case .duplicates:DuplicatesView();case .trash:TrashView();case .uninstaller:UninstallerView();case .memory:MemoryView()}}.frame(maxWidth:.infinity,maxHeight:.infinity)
        }
    }
}
